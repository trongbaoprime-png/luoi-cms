...
export default function Error({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f7f4ed] text-[#1a1612] p-6 text-center font-sans">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-sm border border-stone-200 space-y-4">
        ...
        <p className="text-xs text-stone-500 font-mono leading-relaxed">
          {error.message || "Hệ thống đang tải lại trang để khắc phục sự cố..."}
        </p>
